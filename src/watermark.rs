...
use crate::{console::Console, hls::HLS, site::Site};
    ...
    pub fn get_config() -> Watermark {
        ...
        match watermark_ob {
            ...
            Err(_) => {
                return Watermark {
                    image: "".to_string(),
                    size360p: "0.020".to_string(),
                    size480p: "0.022".to_string(),
                    size720p: "0.025".to_string(),
                    size1080p: "0.028".to_string(),
                }
            }
        }
    }
